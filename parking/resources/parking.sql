...
CREATE TABLE USER (
    ...
    created_date DATETIME NOT NULL DEFAULT SYSDATE COMMENT '가입날짜',
...
CREATE TABLE PARKINGHISTORY(
    user_code VARCHAR(20) NOT NULL COMMENT '회원코드',
    parking_date DATETIME NOT NULL DEFAULT SYSDATE COMMENT '주차날짜',
    parkinglot_name VARCHAR(50) NOT NULL COMMENT '주차장이름',
    parkinglot_addr VARCHAR(50) NOT NULL COMMENT '주차장주소',
...
CREATE REVIEW(
    ...
    created_date DATETIME NOT NULL DEFAULT SYSDATE COMMENT '작성날짜',
    rating TINYINT(1) UNSIGNED NOT NULL COMMENT '평점(1~5 정수)',
    index SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '리뷰글번호',
...
CREATE QNABOARD(
    ...
    created_date DATETIME NOT NULL DEFAULT SYSDATE COMMENT '작성날짜',
    index SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '문의글번호',
...
CREATE NOTICE(
    ...
    index SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '공지사항글번호',
